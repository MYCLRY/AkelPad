...
const char* szHintEdTextA[INLNG_COUNT] = {
    ...
    ( "Enter, F3 \t-  Find next (down)\r\n" \
      ...
      "Ctrl+Enter\t-  Find from beginning\r\n" \
    ...
    ( "Enter, F3 \t-  \xC8\xF1\xEA\xE0\xF2\xFC\x20\xF1\xEB\xE5\xE4\x2E\x20\x28" \
      ...
      "Ctrl+Enter\t-  \xC8\xF1\xEA\xE0\xF2\xFC\x20\xF1\x20\xED\xE0\xF7\xE0" \
      "\xEB\xE0\r\n" \
      "Alt+Enter \t-  \xCF\xEE\xE4\xF5\xE2\xE0\xF2\xE8\xF2\xFC\x20\xE2\xFB" \
    ...
    ( "Enter, F3 \t-  \xD8\xF3\xEA\xE0\xF2\xE8\x20\xED\xE0\xF1\xF2\xF3\xEF\x2E" \
      ...
      "Ctrl+Enter\t-  \xD8\xF3\xEA\xE0\xF2\xE8\x20\xE7\x20\xEF\xEE\xF7\xE0" \
      "\xF2\xEA\xF3\r\n" \
      "Alt+Enter \t-  \xCF\x69\xE4\xF5\xEE\xEF\xE8\xF2\xE8\x20\xE2\xE8\xE4" \
...
const wchar_t* szHintEdTextW[INLNG_COUNT] = {
    ...
    ( L"Enter, F3 \t-  Find next (down)\r\n" \
      ...
      L"Ctrl+Enter\t-  Find from beginning\r\n" \
      L"Alt+Enter \t-  Pick up selected text" ),
    /* rus */
    ( L"Enter, F3 \t-  \x0418\x0441\x043A\x0430\x0442\x044C\x0020\x0441\x043B" \
      ...
      L"\x0029\r\n" \
      L"Ctrl+Enter\t-  \x0418\x0441\x043A\x0430\x0442\x044C\x0020\x0441" \
      L"\x0020\x043D\x0430\x0447\x0430\x043B\x0430\r\n" \
      L"Alt+Enter \t-  \x041F\x043E\x0434\x0445\x0432\x0430\x0442\x0438\x0442" \
    ...
    ( L"Enter, F3 \t-  \x0428\x0443\x043A\x0430\x0442\x0438\x0020\x043D\x0430" \
      ...
      L"Ctrl+Enter\t-  \x0428\x0443\x043A\x0430\x0442\x0438\x0020\x0437" \
      L"\x0020\x043F\x043E\x0447\x0430\x0442\x043A\x0443\r\n" \
      L"Alt+Enter \t-  \x041F\x0069\x0434\x0445\x043E\x043F\x0438\x0442\x0438" \
